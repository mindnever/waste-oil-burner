...
#define HID_SENSOR_VALUE_SIZE_16(x)    (uint8_t)(((uint32_t)x) >> 0), (uint8_t)(((uint32_t)x) >> 8)
#define HID_SENSOR_VALUE_SIZE_32(x)    (uint8_t)(((uint32_t)x) >> 0), (uint8_t)(((uint32_t)x) >> 8), (uint8_t)(((uint32_t)x) >> 16), (uint8_t)(((uint32_t)x) >> 24)

#endif // ifndef _HIDSENSORSPEC_H_
